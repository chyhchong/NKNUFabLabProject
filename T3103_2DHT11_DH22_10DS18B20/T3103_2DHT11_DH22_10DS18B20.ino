...
#define ONE_WIRE_BUS	5 // Arduino D4接到1-Wire裝置-DS18B20 溫度計
 ...
 * 宣告暫存所有感測器資料的一維陣列
 */
#define DATA_NUMBER 16		// 每次抓取感測器數值的數量，4 = 1xDHT + 1xDHT22 + 2xDS18B20 
...
void setup() {
  ...
  dht11B.begin(); // 初始化第一個DHT11感測器
	...
	lcd.print("16 Datas/Row");		// LCD: 輸出指令字串內容
	...
	Serial.println("16 Datas/Row");	// 輸出指令字串內容
