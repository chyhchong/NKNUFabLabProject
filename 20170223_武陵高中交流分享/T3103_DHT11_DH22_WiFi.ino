...
const String sVersion = "v201702023-01";			// 本程式之版本序號，我們必須每次改版後更新此版本序號
...
#define DHT22APIN	3	// DHT22訊號腳接D3
 ...
 * 宣告暫存DHT感測器資料的一維陣列
 */
#define DHT_DATA_NUMBER 	4			// 所有DHTxx感測器數目x2 
float fDHTData[DHT_DATA_NUMBER];// 暫存DHTxx感測器資料用

/*
 * 宣告暫存所有感測器資料的一維陣列
 */
#define DATA_NUMBER 4		// 每次抓取感測器數值的數量，4 = DHT_DATA_NUMBER
...
void getDHTData() {
	...
	fDHTData[2] = dht22A.readTemperature();	// 溫度資料
	fDHTData[3] = dht22A.readHumidity();		// 濕度資料
...
void setup() {
	...
	lcd.print("6 Datas/Row");		// LCD: 輸出指令字串內容
